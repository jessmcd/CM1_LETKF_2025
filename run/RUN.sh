...
sed -i  '6s|.*|''base_dir            = "/work/jessica.mcdonald/CM1_LETKF_2025/experiments/C3_5L09_R0_H2"''|' namelist.py
...
sed -i  '6s|.*|''base_dir            = "/work/jessica.mcdonald/CM1_LETKF_2025/experiments/C3_5L09_R0_H6"''|' namelist.py
sed -i  '43s|.*|''assim_freq          = 180''|' namelist.py
sed -i  '68s|.*|''rhoriz              = 9000.0''|' namelist.py
