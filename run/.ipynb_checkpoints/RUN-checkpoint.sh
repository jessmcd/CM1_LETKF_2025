...
sed -i  '6s|.*|''base_dir            = "/work/jessica.mcdonald/CM1_LETKF_2025/experiments/C3_5L18_R0_noAI"''|' namelist.py
...
sed -i  '54s|.*|''post_inflate        = 1''|' namelist.py
...
sed -i  '6s|.*|''base_dir            = "/work/jessica.mcdonald/CM1_LETKF_2025/experiments/C3_5L09_R0_V2_noAI"''|' namelist.py
sed -i  '43s|.*|''assim_freq          = 180''|' namelist.py
