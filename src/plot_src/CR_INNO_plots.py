...
from cbook2 import nice_mxmnintvl, nice_clevels
...
if __name__ == "__main__":
    ...
    ### 8 panel line plot
    print("MAKING 8-PANEL STATS PLOT FOR REFL AND VR")
    ...
    for ii,var in enumerate(['REFL', 'VR']):
        ...
        dates, CR, IN, SPRD, RMSI = get_stats_timeseries(dirname, only_pos_dbz=True, variable=var)
    ...
    ### 4 panel 2D plots
    print("MAKING 4-PANEL CR and INNOVATION TIME-HEIGHT PLOT FOR REFL AND VR")
    ...
    for ii,var in enumerate(['REFL', 'VR']): 
        TZ, CR, IN, SPRD, RMSI = get_stats_timeseries(dirname, only_pos_dbz=True, variable=var, full_field=True, dz=2000)
