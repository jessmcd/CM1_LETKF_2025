...
if __name__ == '__main__':
	...
	parser.add_option("-f", "--freq",     dest="output_frequency", default=None, type = "int", help = "frequency of output for CM1")
    ...
    # overwrite namelist frequency if it was given as a parser option 
    # this is useful for cook period or forecast output
	if options.output_frequency != None: 
		namelist['param1']['rstfrq'] = options.output_frequency
	...
	for n in np.arange(ne_start-1,ne_end):
